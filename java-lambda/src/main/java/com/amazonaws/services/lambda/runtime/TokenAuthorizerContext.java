...
/**
 * Object representation of input to an implementation of an API Gateway custom authorizer of type
 * TOKEN
 *
 * @author Jack Kohn
 */
public class TokenAuthorizerContext {
   ...
   */
  public TokenAuthorizerContext(final String type, final String authorizationToken,
