      ...
      <div className="fl w-100 w-25-ns pa2">
        ...
        <div className="thumbnail">
          {parent.profilePhotoUrl &&
            <img className="img-rounded img-responsive gma-orange-border" style={{ objectFit: 'cover', maxWidth: '135px', maxHeight: '135px', minWidth: '135px', minHeight: '135px' }} src={parent.profilePhotoUrl} alt="profile" />
          }
          <div className="tc">
